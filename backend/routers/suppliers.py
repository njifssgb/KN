...
from services.label_decoder_service import normalize_pattern as _normalize_label_pattern
...
async def create_supplier(payload: SupplierCreate, request: Request) -> Dict[str, Any]:
    ...
    doc = {
        ...
        **normalize_location(payload.model_dump()),
        ...
        "label_pattern": _normalize_label_pattern(payload.label_pattern),
...
async def update_supplier(supplier_id: str, payload: GenericPatch, request: Request) -> Dict[str, Any]:
    ...
    allowed = {"name", "npwp", "pic_name", "phone", "email", "address", "city",
               ...
               "origin_type", "country", "return_policy", "bank", "label_pattern", *LOCATION_KEYS}
    ...
    if "label_pattern" in updates:
        updates["label_pattern"] = _normalize_label_pattern(
            updates["label_pattern"] if isinstance(updates["label_pattern"], dict) else None)
