        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <label className="block">
            ...
            <div className="flex gap-1">
              ...
              <select data-testid="unreadable-length-unit" value={f.length_unit} onChange={(e) => setF({ ...f, length_unit: e.target.value })}
                className="field !w-20">
                <option value="yard">yd</option><option value="meter">m</option>
              </select>
            </div>
          </label>
          <label className="block">
